      ...
      .col-xl-10
        ...
        LineaTiempoD.color-secundario.mb-5
          .row.justify-content-center(numero="1924" titulo="El segundo período") 
            ...
            .col-lg-5.order-1.order-lg-2.col-md-10
              figure.mb-4.mb-lg-0
          ...
          .row.justify-content-center(numero="1936" titulo="El tercer período")
            ...
            .col-lg-6.mt-3.order-1.order-lg-2.col-md-10
              figure.mb-4.mb-lg-0
