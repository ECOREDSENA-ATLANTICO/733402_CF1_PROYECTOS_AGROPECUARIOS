    ...
    .row.justify-content-center.align-items-center(data-aos="fade-left")
      .col-lg-10
        ...
        .bloque-texto-f.color-secundario.pt-4.px-5.mb-3.fnd-1
          ...
          h5.text-regular.bloque-texto-f__texto “Mariano Arango (1994) hizo uno de los mejores relatos históricos, donde combina el análisis con las principales políticas de tierras desde 1874 hasta los proyectos de ley presentados a comienzos de la administración Barco en 1987. El estudio de Kalmanovitz y López, la agricultura colombiana en el siglo XX (2006) es una buena aproximación a una historia económica de las políticas en mención durante un período extenso” 
      ...
      .col-lg-10
        ...
        .bloque-texto-f.color-secundario.pt-4.px-5.fnd-1-.fnd-1
          .bloque-texto-f__comillas
            i.fas.fa-quote-left
            i.fas.fa-quote-right
          h5.text-regular.bloque-texto-f__texto "un proceso de apropiación de la tierra, de formación de la gran propiedad territorial que no conlleva, con la misma intensidad, un proceso de expropiación en cuanto se apoya fundamentalmente sobre la expansión de la frontera agrícola y no sobre la expropiación de los pequeños productores". Se trata entonces de un proceso en el que se forma una capa de pequeños productores paralela a la gran propiedad rural.  
          
          .bloque-texto-f__autor.mb-3
            h5.mb-0 (Machado, 1997, p.241).
      ...
      .col-xl-10
        ...
        LineaTiempoD.color-secundario.mb-5
          ...
          .row.justify-content-center(numero="1961" titulo="El sexto período")
            ...
            .col-lg-4.col-xl-3.mt-3.col-md-8.order-2.order-lg-1
              figure.mb-4.mb-lg-0.mb-xl-2
                img(src='@/assets/curso/temas/tema1/img-7.png')    

            .col-lg-12.mb-4.mb-md-0.order-3.order-lg-3                 
          ...
          .row.justify-content-center(numero="1970" titulo="El séptimo período")
            .col-lg-6.mb-4.mb-md-0.mt-3.order-2.order-lg-1
          ...
          .row.justify-content-center(numero="1988" titulo="El octavo período")

              p.mt-3 Reactivación temporal de la reforma agraria (1988-1994). El presidente Betancur organizó una comisión de diálogo nacional para mermar la violencia y una subcomisión agraria conformada por distintos gremios y organizaciones, incluso los grupos armados, donde se establece un acuerdo de reforma agraria, pero este no tuvo el consenso del campesinado y no logra aprobarse sino hasta la presidencia de Barco a través de la ley 30 de 1988. 
              p.mb-5 Básicamente, al igual que otros mecanismos como el acuerdo de Chicoral, se define en estas normas los criterios para calificar los predios como adecuadamente o no explotados y los parámetros para, por ejemplo, expropiar para la reforma, hasta ahora estos puntos declarados inexequibles por el Consejo de Estado. La ley 30, al fin aplica una norma de función social de la propiedad y todo predio rural es susceptible, aquí, de ser parte de la reforma. Con esta ley también se introducen elementos modernizadores como el fortalecimiento del Fondo Nacional Agrario (FNA), se crea un fondo de capacitación y el Fondo Nacional de Adecuación de tierras, centros de arrendamiento de maquinaria agrícola, se facilitan las negociaciones de predios para su adquisición, programas regionales de reforma, entre otros mecanismos políticos para la mejora de la productividad y equidad en la ruralidad (Machado, 2009). Como resalta Machado del discurso del Presidente Virgilio Barco en el acto de sanción de la Ley 30 de 1988:
              .row.justify-content-center.align-items-center
                .col-lg-11
                  .bloque-texto-f.color-primario.pt-4.px-5.fnd-3
                    .bloque-texto-f__comillas
                      i.fas.fa-quote-left
                      i.fas.fa-quote-right
                    h5.text-regular.bloque-texto-f__texto.text-white La importancia que el gobierno de Barco le dio a la recuperación de la reforma agraria quedó expresada en su afirmación contundente de que era en sí misma - una terapia para la reconciliación nacional y social y el mecanismo más eficaz para integrar a la vida política, social y económica a los colombianos marginados de las áreas rurales.
                    
                    .bloque-texto-f__autor.mb-3
                      h4.mb-0.text-white (Machado, 2009, p.163).

          
          
          .row.justify-content-center(numero="1995" titulo="El noveno período")
            .col-lg-6.mb-4.mb-md-0.mt-3.order-2.order-lg-1
          ...
          .row.justify-content-center(numero="2000" titulo="El decimo período")
            .col-lg-8.col-xl-9.mb-4.mb-md-0.mt-3.order-2.order-lg-1
            ...
            .col-lg-4.col-xl-3.mt-3.order-1.order-lg-2.col-md-8
              figure.mb-4.mb-lg-0
          ...
          .row.justify-content-center(numero="2011" titulo="El décimoprimer período")
            .col-lg-6.mb-4.mb-md-0.mt-3.order-2.order-lg-1
